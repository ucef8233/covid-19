...
var recup = function () {
  ...
  if (reponces.length === 0) {
    ...
    for (let k = 0; k < reponces.length; k++) {
      reponces[k].addEventListener("click", function (e) {
        if (reponces[0].checked) {
          info.splice(i, 1, "Oui");
        } else if (reponces[1].checked) {
          info.splice(i, 1, "Non");
...
var Question = [
  //1/////
  {
    ...
    /// oui . non /////
    rep:
      ' <input type="radio" id="form__choice" name="question" value="Oui" checked><label for="oui">Oui</label> <br> <input type="radio" id="form__choice" name="question" value="Non"><label for="non">Non</label><br><br></br>',
  },
  ...
  //////3/////
  {
    ...
    /// oui . non /////
    rep:
      ' <input type="radio" id="form__choice" name="question" checked><label for="oui">Oui</label> <br> <input type="radio" id="form__choice" name="question"><label for="non">Non</label><br><br></br>',
  },
